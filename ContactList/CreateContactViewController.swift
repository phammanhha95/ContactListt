...
//        view.backgroundColor = UIColor(red:0.04, green:0.04, blue:0.04, alpha:1.0)
    ...
    @objc func saveItem(){
        ...
        passObject?(Contact(photo: avatarImage.image, name: nameTextField.text!, phone: phoneTextField.text!, note: noteTextView.text, group: GroupType(rawValue: groupTextField.text!)!, id: uuid  ))
    ...
    func creategroupPicker() {
        ...
        groupPicker.backgroundColor = .white
    }
    func createToolbar() {
